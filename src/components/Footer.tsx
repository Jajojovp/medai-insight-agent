        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              {language === 'es' ? 'Plataforma profesional de análisis médico con inteligencia artificial y 37+ modelos especializados.' :
               language === 'fr' ? 'Plateforme professionnelle d\'analyse médicale avec intelligence artificielle et 37+ modèles spécialisés.' :
               'Professional medical analysis platform with artificial intelligence and 37+ specialized models.'}
            </p>
          </div>
