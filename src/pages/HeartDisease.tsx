...
import { ArrowLeft, Heart, TrendingUp, AlertTriangle, CheckCircle, Brain } from "lucide-react";
...
const HeartDisease = () => {
  const riskFactors = [
    ...
    "Colesterol alto (LDL >130 mg/dl)",
    "Tabaquismo",
    "Diabetes mellitus",
    "Obesidad (IMC >30)",
    "Vida sedentaria",
    "Historia familiar cardiovascular",
    "Edad (>65 años hombres, >55 mujeres)",
    "Estrés crónico",
  ...
  const analysisModels = [
    {
      name: "Modelo de Riesgo Cardiovascular",
      accuracy: "93.7%",
      description: "Evaluación integral de factores de riesgo cardiovascular"
    },
    {
      name: "Modelo de Electrocardiograma",
      accuracy: "95.2%",
      description: "Análisis de patrones ECG y arritmias"
    },
    {
      name: "Modelo de Biomarcadores",
      accuracy: "91.8%",
      description: "Análisis de troponinas, BNP y otros marcadores"
    },
    {
      name: "Modelo de Imagen Cardíaca",
      accuracy: "94.6%",
      description: "Evaluación de ecocardiogramas y angiografías"
    },
    {
      name: "Modelo de Predicción de Eventos",
      accuracy: "88.9%",
      description: "Predicción de infartos y eventos cardiovasculares"
    }
  ];
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="text-center space-y-6 mb-12">
          ...
          <h1 className="text-5xl font-bold bg-gradient-to-r from-red-600 to-pink-600 bg-clip-text text-transparent">
            Análisis Predictivo de Enfermedades Cardíacas
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Detección temprana y evaluación de riesgo cardiovascular con IA médica especializada
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          <Card className="hover:shadow-xl transition-all duration-300 backdrop-blur-md bg-white/80 border border-white/30 rounded-3xl">
            ...
            <CardContent className="text-center">
              <div className="text-3xl font-bold text-red-600 mb-2">6.2%</div>
              <p className="text-gray-600">
                Principal causa de muerte a nivel mundial, afecta a millones
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-xl transition-all duration-300 backdrop-blur-md bg-white/80 border border-white/30 rounded-3xl">
            ...
            <CardContent className="text-center">
              ...
              <p className="text-gray-600">
                Los eventos cardiovasculares se pueden prevenir con detección temprana
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-red-50/30 to-pink-50/30 border-0 backdrop-blur-md border border-white/30 rounded-3xl p-8">
            <CardContent>
              ...
              <p className="text-lg text-gray-600 mb-6 max-w-2xl mx-auto">
                Utiliza nuestros 5 modelos especializados de IA para evaluar el riesgo cardiovascular con precisión médica profesional
              </p>
              <Link to="/login">
                <Button className="bg-red-600 hover:bg-red-700 rounded-2xl text-lg px-8 py-3">
                  Iniciar Análisis Cardiovascular
                </Button>
              </Link>
            </CardContent>
          </Card>
