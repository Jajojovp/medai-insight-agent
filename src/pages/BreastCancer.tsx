              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <div>
                      <strong>Luminal A:</strong> {language === "es" ? "RE+/RP+, HER2-, Ki67 menor de 14%. Mejor pronóstico (70% casos)" : language === "fr" ? "RE+/RP+, HER2-, Ki67 moins de 14%. Meilleur pronostic (70% cas)" : "ER+/PR+, HER2-, Ki67 less than 14%. Best prognosis (70% cases)"}
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-4 w-4 mr-2 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>Luminal B:</strong> {language === "es" ? "RE+, HER2- o HER2+, Ki67 mayor o igual a 14%. Pronóstico intermedio (20% casos)" : language === "fr" ? "RE+, HER2- ou HER2+, Ki67 supérieur ou égal à 14%. Pronostic intermédiaire (20% cas)" : "ER+, HER2- or HER2+, Ki67 greater than or equal to 14%. Intermediate prognosis (20% cases)"}
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-4 w-4 mr-2 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>HER2 Enriquecido:</strong> {language === "es" ? "RE-/RP-, HER2+. Agresivo pero responde a terapia dirigida (5% casos)" : language === "fr" ? "RE-/RP-, HER2+. Agressif mais répond à thérapie ciblée (5% cas)" : "ER-/PR-, HER2+. Aggressive but responds to targeted therapy (5% cases)"}
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-4 w-4 mr-2 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>Triple Negativo:</strong> {language === "es" ? "RE-/RP-/HER2-. Más agresivo, opciones terapéuticas limitadas (5% casos)" : language === "fr" ? "RE-/RP-/HER2-. Plus agressif, options thérapeutiques limitées (5% cas)" : "ER-/PR-/HER2-. More aggressive, limited therapeutic options (5% cases)"}
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>• <strong>BRCA1/BRCA2:</strong> {language === "es" ? "Riesgo 45-85% (iniciar cribado a los 25-30 años)" : language === "fr" ? "Risque 45-85% (commencer dépistage à 25-30 ans)" : "45-85% risk (start screening at 25-30 years)"}</li>
                  <li>• <strong>{language === "es" ? "Historia familiar:" : language === "fr" ? "Histoire familiale:" : "Family history:"}</strong> {language === "es" ? "2 o más familiares de primer grado con cáncer de mama/ovario" : language === "fr" ? "2 ou plus parents de premier degré avec cancer sein/ovaire" : "2 or more first-degree relatives with breast/ovarian cancer"}</li>
                  <li>• <strong>{language === "es" ? "Radioterapia torácica:" : language === "fr" ? "Radiothérapie thoracique:" : "Chest radiation:"}</strong> {language === "es" ? "Antes de los 30 años (ej. linfoma Hodgkin)" : language === "fr" ? "Avant 30 ans (ex. lymphome Hodgkin)" : "Before age 30 (e.g., Hodgkin lymphoma)"}</li>
                  <li>• <strong>{language === "es" ? "Síndromes genéticos:" : language === "fr" ? "Syndromes génétiques:" : "Genetic syndromes:"}</strong> Li-Fraumeni, Cowden, Peutz-Jeghers</li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>• <strong>{language === "es" ? "Edad:" : language === "fr" ? "Âge:" : "Age:"}</strong> {language === "es" ? "Riesgo aumenta con la edad (77% casos mayor de 50 años)" : language === "fr" ? "Risque augmente avec l'âge (77% cas supérieur à 50 ans)" : "Risk increases with age (77% cases over 50 years)"}</li>
                  <li>• <strong>{language === "es" ? "Menarquia precoz:" : language === "fr" ? "Ménarche précoce:" : "Early menarche:"}</strong> {language === "es" ? "menor de 12 años" : language === "fr" ? "moins de 12 ans" : "less than 12 years"}</li>
                  <li>• <strong>{language === "es" ? "Menopausia tardía:" : language === "fr" ? "Ménopause tardive:" : "Late menopause:"}</strong> {language === "es" ? "mayor de 55 años" : language === "fr" ? "supérieur à 55 ans" : "over 55 years"}</li>
                  <li>• <strong>{language === "es" ? "Nuliparidad:" : language === "fr" ? "Nulliparité:" : "Nulliparity:"}</strong> {language === "es" ? "No haber tenido hijos" : language === "fr" ? "Ne pas avoir eu d'enfants" : "Never having children"}</li>
                  <li>• <strong>{language === "es" ? "Primer embarazo tardío:" : language === "fr" ? "Première grossesse tardive:" : "Late first pregnancy:"}</strong> {language === "es" ? "mayor de 30 años" : language === "fr" ? "supérieur à 30 ans" : "over 30 years"}</li>
                  <li>• <strong>{language === "es" ? "Terapia hormonal:" : language === "fr" ? "Thérapie hormonale:" : "Hormone therapy:"}</strong> {language === "es" ? "mayor de 5 años (especialmente estrógeno + progestina)" : language === "fr" ? "supérieur à 5 ans (surtout œstrogène + progestine)" : "over 5 years (especially estrogen + progestin)"}</li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>• <strong>{language === "es" ? "Mamografía bilateral:" : language === "fr" ? "Mammographie bilatérale:" : "Bilateral mammography:"}</strong> {language === "es" ? "Anual 40-49 años, cada 1-2 años 50-74 años" : language === "fr" ? "Annuelle 40-49 ans, tous les 1-2 ans 50-74 ans" : "Annual 40-49 years, every 1-2 years 50-74 years"}</li>
                  <li>• <strong>{language === "es" ? "Resonancia magnética:" : language === "fr" ? "Résonance magnétique:" : "MRI:"}</strong> {language === "es" ? "Anual para riesgo alto (BRCA+, score mayor o igual a 20%)" : language === "fr" ? "Annuelle pour haut risque (BRCA+, score supérieur ou égal à 20%)" : "Annual for high risk (BRCA+, score greater than or equal to 20%)"}</li>
                  <li>• <strong>{language === "es" ? "Ecografía mamaria:" : language === "fr" ? "Échographie mammaire:" : "Breast ultrasound:"}</strong> {language === "es" ? "Complemento en mamas densas" : language === "fr" ? "Complément dans seins denses" : "Complement in dense breasts"}</li>
                  <li>• <strong>{language === "es" ? "Tomosíntesis (3D):" : language === "fr" ? "Tomosynthèse (3D):" : "Tomosynthesis (3D):"}</strong> {language === "es" ? "Mejora detección en mamas densas" : language === "fr" ? "Améliore détection dans seins denses" : "Improves detection in dense breasts"}</li>
                </ul>
              </div>
            </div>
          </CardContent>
              ...
              <div>
                ...
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start">
                    <CheckCircle className="h-4 w-4 mr-2 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>{language === "es" ? "Biopsia core:" : language === "fr" ? "Biopsie au trocart:" : "Core needle biopsy:"}</strong> {language === "es" ? "Estándar de oro para diagnóstico histológico. Evaluar RE, RP, HER2, Ki67 en todas las muestras" : language === "fr" ? "Étalon-or pour diagnostic histologique. Évaluer RE, RP, HER2, Ki67 sur tous les échantillons" : "Gold standard for histological diagnosis. Assess ER, PR, HER2, Ki67 on all samples"}
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-4 w-4 mr-2 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>{language === "es" ? "Estadificación TNM:" : language === "fr" ? "Stadification TNM:" : "TNM staging:"}</strong> {language === "es" ? "TC tórax-abdomen-pelvis, gammagrafía ósea si T3-T4 o N+. PET-TC en casos seleccionados" : language === "fr" ? "TDM thorax-abdomen-pelvis, scintigraphie osseuse si T3-T4 ou N+. TEP-TDM dans cas sélectionnés" : "CT chest-abdomen-pelvis, bone scan if T3-T4 or N+. PET-CT in selected cases"}
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-4 w-4 mr-2 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>{language === "es" ? "Pruebas genómicas:" : language === "fr" ? "Tests génomiques:" : "Genomic testing:"}</strong> {language === "es" ? "Oncotype DX, MammaPrint para cáncer RE+ estadio I-II en toma de decisiones de quimioterapia" : language === "fr" ? "Oncotype DX, MammaPrint pour cancer RE+ stade I-II dans prise de décisions chimiothérapie" : "Oncotype DX, MammaPrint for ER+ stage I-II cancer in chemotherapy decision making"}
                    </div>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start">
                    <CheckCircle className="h-4 w-4 mr-2 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>{language === "es" ? "Cirugía:" : language === "fr" ? "Chirurgie:" : "Surgery:"}</strong> {language === "es" ? "Cirugía conservadora + RT vs mastectomía. Biopsia ganglio centinela estándar. Reconstrucción inmediata/diferida si mastectomía" : language === "fr" ? "Chirurgie conservatrice + RT vs mastectomie. Biopsie ganglion sentinelle standard. Reconstruction immédiate/différée si mastectomie" : "Breast-conserving surgery + RT vs mastectomy. Sentinel lymph node biopsy standard. Immediate/delayed reconstruction if mastectomy"}
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-4 w-4 mr-2 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>{language === "es" ? "Quimioterapia:" : language === "fr" ? "Chimiothérapie:" : "Chemotherapy:"}</strong> {language === "es" ? "Adyuvante: AC-T, TC, AC-TH (HER2+). Neoadyuvante: indicada si T3-T4, N2-N3, o triple negativo mayor de 2cm" : language === "fr" ? "Adjuvante: AC-T, TC, AC-TH (HER2+). Néoadjuvante: indiquée si T3-T4, N2-N3, ou triple négatif supérieur à 2cm" : "Adjuvant: AC-T, TC, AC-TH (HER2+). Neoadjuvant: indicated if T3-T4, N2-N3, or triple negative over 2cm"}
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-4 w-4 mr-2 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>{language === "es" ? "Hormonoterapia:" : language === "fr" ? "Hormonothérapie:" : "Hormone therapy:"}</strong> {language === "es" ? "Tamoxifeno 5-10 años (premenopáusicas), inhibidores aromatasa 5-10 años (postmenopáusicas)" : language === "fr" ? "Tamoxifène 5-10 ans (préménopausées), inhibiteurs aromatase 5-10 ans (postménopausées)" : "Tamoxifen 5-10 years (premenopausal), aromatase inhibitors 5-10 years (postmenopausal)"}
                    </div>
                  </li>
                </ul>
              </div>
