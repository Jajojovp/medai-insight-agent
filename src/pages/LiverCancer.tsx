  ...
  const analysisModels = [
    {
      ...
      accuracy: "92.5%",
      description: "Análisis de tomografías computarizadas (TC) y resonancias magnéticas (RM)"
    },
    {
      name: "Modelo de Marcadores Tumorales",
      accuracy: "90.3%",
      description: "Análisis de niveles de alfa-fetoproteína (AFP) y otros marcadores"
    },
    {
      name: "Modelo de Factores de Riesgo",
      accuracy: "88.7%",
      description: "Evaluación de factores de riesgo como hepatitis y cirrosis"
    },
    {
      name: "Modelo de Biopsia Líquida",
      accuracy: "94.1%",
      description: "Análisis de ADN tumoral circulante en sangre"
    },
    {
      name: "Modelo de Predicción de Recurrencia",
      accuracy: "86.9%",
      description: "Predicción del riesgo de recurrencia post-tratamiento"
    }
  ];
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="text-center space-y-6 mb-12">
          ...
          <h1 className="text-5xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
            Análisis Predictivo de Cáncer de Hígado
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Detección temprana y evaluación de riesgo con IA médica avanzada para el cáncer hepático
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          <Card className="hover:shadow-xl transition-all duration-300 backdrop-blur-md bg-white/80 border border-white/30 rounded-3xl">
            ...
            <CardContent className="text-center">
              ...
              <p className="text-gray-600">
                Afecta a millones de personas a nivel mundial, con alta mortalidad
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-xl transition-all duration-300 backdrop-blur-md bg-white/80 border border-white/30 rounded-3xl">
            ...
            <CardContent className="text-center">
              ...
              <p className="text-gray-600">
                Aumenta la supervivencia con detección en etapas iniciales
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-xl transition-all duration-300 backdrop-blur-md bg-white/80 border border-white/30 rounded-3xl">
            ...
            <CardContent className="text-center">
              ...
              <p className="text-gray-600">
                Precisión promedio de nuestros modelos especializados
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {analysisModels.map((model, index) => (
                <div key={index} className="p-6 backdrop-blur-sm bg-gradient-to-br from-green-50/30 to-emerald-50/30 rounded-2xl border border-white/30">
                  <div className="flex justify-between items-start mb-3">
                    <h3 className="font-semibold text-lg">{model.name}</h3>
                    <Badge className="bg-green-600 text-white">{model.accuracy}</Badge>
                  </div>
          ...
          <Card className="bg-gradient-to-br from-green-50/30 to-emerald-50/30 border-0 backdrop-blur-md border border-white/30 rounded-3xl p-8">
            <CardContent>
              ...
              <p className="text-lg text-gray-600 mb-6 max-w-2xl mx-auto">
                Utiliza nuestros modelos especializados de IA para evaluar el riesgo de cáncer de hígado con precisión médica profesional
              </p>
              <Link to="/login">
                <Button className="bg-green-600 hover:bg-green-700 rounded-2xl text-lg px-8 py-3">
                  Iniciar Análisis de Cáncer de Hígado
                </Button>
              </Link>
            </CardContent>
          </Card>
